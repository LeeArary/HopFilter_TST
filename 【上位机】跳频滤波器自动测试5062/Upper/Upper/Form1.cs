    ...
    public partial class Main_Form : Form
    {
        ...
        private void serialPort1_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            else if (Device_info.Receive_mode == 4)//【并行】读取到的是矢网的Bw，CNT，Q，LOSS
            {
                ...
                {
                    if (Math.Abs(Cent - Device_info.Parall_info.preFrq) < 0.01 && reRead==0)//再读一次
                    {
                        reRead=1;
        ...
        {
            if (Device_info.Parall_info.test_sta != 0 && Device_info.Parall_info.test_sta != 1 && Device_info.Parall_info.test_sta != 11 && Device_info.Parall_info.test_sta != 12)
            ...
            if (Device_info.Parall_info.test_sta == 0)//配置起始频率50M
            {
                ...
                serialPort1_Write("SENS1:FREQ:STAR " + Device_info.Parall_info.Start1Frq + "E6");
                Device_info.Parall_info.test_sta = 1;         
                Thread.Sleep(300);
            }
            else if (Device_info.Parall_info.test_sta == 1)//配置终止频率500M
            {
                serialPort1_Write("SENS1:FREQ:STOP " + Device_info.Parall_info.Stop1Frq + "E6");
            ...
            {
                Thread.Sleep(100);
                serialPort1_Write("SENS1:FREQ:STAR " + Device_info.Parall_info.Start2Frq + "E6");
                Thread.Sleep(100);
                serialPort1_Write("SENS1:FREQ:STOP " + Device_info.Parall_info.Start2Frq + "E6");
            ...
            {
                Thread.Sleep(100);
                serialPort1_Write("SENS1:FREQ:STOP " + Device_info.Parall_info.Stop2Frq + "E6");
                Thread.Sleep(100);
                serialPort1_Write("SENS1:FREQ:STOP " + Device_info.Parall_info.Stop2Frq + "E6");
